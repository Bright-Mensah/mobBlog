...
if(empty($title)){
  ...
  $msg = "<div class='alert alert-warning text-center text-dark'>Description can't be empty</div>";
    ...
    $msg = "<div class='alert alert-warning text-center text-dark'>Select a category</div>";
    ...
    $query = "insert into post(title,description,category,image,post_by)values('$title','$description','$category','$imageName','$userName')";
